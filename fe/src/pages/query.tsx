...
export default function Home() {
    ...
    const handleUpload = (e: React.FormEvent<HTMLInputElement>) => {
        ...
        let img = URL.createObjectURL(target.files[0] || file)
        setImageLink(img)
    ...
    return (
        <Layout>
            <div
                className="h-1/4 vh-3/4 p-4"
            >
                <form className="grid grid-cols-5 grid-rows-3 gap-2 bg-indigo-50 rounded-3xl p-6" 
                ...
                >
                    ...
                    <div className="col-start-1 col-end-3 row-start-2 row-end-4">
                        <div className="flex items-center px-2 py-1 justify-center">
                            <label htmlFor="OCR" className="block text-sm font-semibold text-gray-900 dark:text-white min-w-12 required">OCR :</label>
                            <input id="OCR" type="text" placeholder="Ex. VN Airline, stop, ..." name="ocr" autoComplete="off" aria-label="OCRSearch"
                            className="w-full ml-4 px-3 py-2 font-semibold text-sm placeholder-gray-500 text-black rounded-xl border-none ring-2 ring-gray-300 focus:ring-gray-500 focus:ring-2"></input>
                        </div>
                        <div className="flex items-center px-2 py-1 justify-center">
                            <label htmlFor="Speech" className="block text-sm font-semibold text-gray-900 dark:text-white min-w-12 required">Speech:</label>
                            <input id="Speech" type="text" placeholder="Ex. VN Airline, stop, ..." name="speech" autoComplete="off" aria-label="SpeechSearch"
                            className="w-full ml-4 px-3 py-2 font-semibold text-sm placeholder-gray-500 text-black rounded-xl border-none ring-2 ring-gray-300 focus:ring-gray-500 focus:ring-2"></input>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center">
                        ...
                        <select id="typedata" name="typedata" defaultValue={"Image"} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm font-bold text-center rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    ...
                    <div className="col-start-3 col-end-4 row-start-2 row-end-4">
                        ...
                        <label htmlFor="input-file" id="drop-area">
                            ...
                            <div id="img-view" className="m-auto h-full bg-red-100 cursor-pointer rounded-3xl bg-center bg-no-repeat text-center border-dashed border-2 border-indigo-600 hover:opacity-50"
                                style={{
                            ...
                            >
                                <div style= {{
                                    ...
                                    <p className="text-xs">
                                        Drag and drop <br className="hidden md:inline"/> or <span className="text-blue-500 font-extrabold">click here</span> <span className="hidden lg:inline"> to upload an image </span>
                                    </p>
                                </div>
                            </div>
                    ...
                    <button type="button" className="px-2 py-1 bg-blue-400 w-3/4 rounded-xl mx-auto my-0.5 text-white font-semibold hover:border-blue-600 hover:border-solid hover:opacity-90 hover:border-2 hover:text-blue-400 hover:bg-white">
                            Choose folder
                    </button>
                    ...
                    <div className="flex items-center">
                        <label htmlFor="topk" className="block text-sm ml-1 font-semibold text-gray-900 dark:text-white min-w-[90px] required">Top-k <span className="text-red-500">*</span> :</label>
                        
                        <select id="topk" defaultValue={200} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm font-bold text-center rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
