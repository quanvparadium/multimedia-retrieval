...
//   }, []);
  ...
  return (
    <div className={classNames(`bg-white  transition-all ease-in-out rounded-full`, {
      ...
      <div className="flex flex-row justify-between toggle">
        <label htmlFor="dark-toggle" className="flex items-center cursor-pointer">
          <div className="relative ">
            ...
            {!isDarkMode ? <div className={`dot absolute left-1 top-1 ${isDarkMode ? 'bg-gray-800' : 'bg-gray-800'} w-5 h-5 rounded-full transition`} /> :
            <div className={`dot absolute right-1 top-1 bg-white ${isDarkMode ? 'bg-gray-800' : 'bg-gray-800'} w-5 h-5 rounded-full transition`} />}
